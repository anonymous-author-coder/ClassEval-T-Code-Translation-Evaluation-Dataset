...
public class NumberWordFormatter {
    ...
    public String[] NUMBER = { "", "ONE", "TWO", "THREE", "FOUR", "FIVE", "SIX", "SEVEN", "EIGHT", "NINE" };

    public String[] NUMBER_TEEN = { "TEN", "ELEVEN", "TWELVE", "THIRTEEN", "FOURTEEN", "FIFTEEN", "SIXTEEN", "SEVENTEEN", "EIGHTEEN", "NINETEEN" };

    public String[] NUMBER_TEN = { "TEN", "TWENTY", "THIRTY", "FORTY", "FIFTY", "SIXTY", "SEVENTY", "EIGHTY", "NINETY" };

    public String[] NUMBER_MORE = { "", "THOUSAND", "MILLION", "BILLION" };

    public String[] NUMBER_SUFFIX = { "k", "w", "", "m", "", "", "b", "", "", "t", "", "", "p", "", "", "e" };
