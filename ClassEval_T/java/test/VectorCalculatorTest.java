...
class VectorCalculatorTest {
    ...
    void testSimilarity1() {
        double[] vector1 = {1, 1};
        double[] vector2 = {1, 0};
        double similarity = VectorCalculator.similarity(vector1, vector2);
    ...
    void testCosineSimilarities1() {
        ...
        List<Double> similarities = VectorCalculator.cosineSimilarities(vector1, vectorsAll);
    ...
    void testNSimilarity1() {
        ...
        double similarity = VectorCalculator.nSimilarity(vectorList1, vectorList2);
        assertEquals(1.0, similarity, 1e-15);
    }
    ...
    void testComputeIdfWeightDict1() {
        ...
        Map<String, Double> res = VectorCalculator.computeIdfWeightDict(2, numDict);
    ...
    void testVectorCalculator() {
        ...
        List<double[]> vectorList1 = List.of(new double[]{1, 0}, new double[]{0, 1});
        List<double[]> vectorList2 = List.of(new double[]{0, 0}, new double[]{1, 1});
        double nSimilarity = VectorCalculator.nSimilarity(vectorList1, vectorList2);
